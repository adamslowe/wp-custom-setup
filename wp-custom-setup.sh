...
function wp_user_admin_defaults(){ echo "Setting default admin and developer user settings"
    ...
    wp user create devteam_$domain_identifier devteam@peakperformancedigital.com --role=administrator --display_name="Website Developer" --nickname="Website Developer" --first_name="Website" --last_name="Developer"
}
...
function install_config_fluentsmtp(){ echo "Installing and configuring Fluent SMTP"
    ...
    wp option update fluentmail-settings --format=json '{"mappings":{"wordpress@peakperformancedigital.com":"2a001e2752255da416d3467ed4893ecb"},"connections":{"2a001e2752255da416d3467ed4893ecb":{"title":"SendGrid","provider_settings":{"sender_name":"'"$site_name"'","sender_email":"wordpress@peakperformancedigital.com","force_from_name":"no","force_from_email":"no","api_key":"","key_store":"db","provider":"sendgrid"}}},"misc":{"log_emails":"yes","log_saved_interval_days":"14","disable_fluentcrm_logs":"no","default_connection":"2a001e2752255da416d3467ed4893ecb"}}'
}
...
function get_backup_input(){
    select_server_type
    echo "Backup Notification Email Address (Backup@PeakPerformanceDigital.com):"; read backup_email_address; backup_email_address="${backup_email_address:="Backup@PeakPerformanceDigital.com"}"
}
